...
class Worker:
    ...
    def handle_watchlist_trade_scan(self, params: dict) -> dict:
        ...
        for sym in watchlist:
            ...
            _time.sleep(1 if scan_type == "intraday" else 2)
    ...
    def handle_eod_scan(self, params: dict) -> dict:
        ...
        Uses POPULAR_STOCKS (not full NSE universe) — Yahoo Finance at night is
        too slow for 2600+ stocks within the 9-min job timeout.
        """
